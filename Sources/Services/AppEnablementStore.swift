...
enum AppCategory: String, CaseIterable, Codable, Sendable {
    ...
    var kinds: [WorkspacePanelKind] {
        ...
        case .swiftApps:
            ...
            return [.audioControl, .mediaPlayer, .notesMD, .voiceNotes, .canvas, .kanban, .terminalApp, .webBrowser, .damBrowser, .maestroDocs, .maestroBooks, .maestroDB, .htmlBuilder, .backup, .stocks, .blocky, .pomodoro, .rssReader, .publish]
        }
    }
...
extension WorkspacePanelKind {
    ...
    var appCategory: AppCategory? {
        ...
        case .tethering, .streamIngest, .broadcast, .streamMixer, .ndiBrowser, .colorAdjustments, .scenes:
            return .studio
        case .audioControl, .mediaPlayer, .notesMD, .voiceNotes, .canvas, .kanban, .terminal, .webBrowser, .damBrowser, .maestroDocs, .maestroBooks, .maestroDB, .htmlBuilder, .backup, .stocks, .blocky, .pomodoro, .mapquest, .rssReader, .publish:
            return .swiftApps
        default:
            return nil
        }
