...
enum AppCategory: String, CaseIterable, Codable, Sendable {
    ...
    var kinds: [WorkspacePanelKind] {
        ...
        case .swiftApps:
            return [.busMonitor, .audioControl, .notesMD, .canvas, .kanban, .terminal, .webBrowser, .damBrowser, .maestroDocs, .maestroBooks, .maestroDB, .overlayBuilder, .backup]
        }
    }
...
extension WorkspacePanelKind {
    ...
    var appCategory: AppCategory? {
        ...
        case .tethering, .streamIngest, .broadcast, .streamMixer, .ndiBrowser, .colorAdjustments, .scenes:
            return .studio
        case .busMonitor, .audioControl, .notesMD, .canvas, .kanban, .terminal, .webBrowser, .damBrowser, .maestroDocs, .maestroBooks, .maestroDB, .overlayBuilder, .backup:
            return .swiftApps
        default:
            return nil
        }
