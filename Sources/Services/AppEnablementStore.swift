...
enum AppCategory: String, CaseIterable, Codable, Sendable {
    ...
    var kinds: [WorkspacePanelKind] {
        ...
        case .swiftApps:
            return [.whatsapp, .discord, .busMonitor, .audioControl, .notesMD, .canvas, .kanban, .terminal, .webBrowser, .damBrowser, .maestroDocs, .maestroBooks]
        }
    }
}
...
extension WorkspacePanelKind {
    ...
    var appCategory: AppCategory? {
        ...
        case .tethering, .streamIngest, .broadcast, .streamMixer, .ndiBrowser, .colorAdjustments, .scenes:
            return .studio
        case .whatsapp, .discord, .busMonitor, .audioControl, .notesMD, .canvas, .kanban, .terminal, .webBrowser, .damBrowser, .maestroDocs, .maestroBooks:
            return .swiftApps
        default:
            return nil
        }
