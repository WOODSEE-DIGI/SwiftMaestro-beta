...
extension MaestroTools {
    ...
    static func registerAllMigratedTools() async {
        ...
        await registerBrowserExtensionTools()
        await registerBlueskyTools()
        await registerMastodonTools()
        await registerSocialPlatformTools()
        await registerVideoPlatformTools()
        await registerMoreVideoPlatformTools()
        await registerPatreonTools()
        await registerDatabaseTools()
        await registerDAMTools()
        await registerContactCardTools()
        await registerPomodoroTools()
        await registerRSSTools()
